...
public class ActivityTaskManagerService extends IActivityTaskManager.Stub {
    ...
    private final class ScreenRatioSettingsObserver extends ContentObserver {
        private final Uri mScreenRatioAppsUri = Settings.System.getUriFor(Settings.System.AICP_ASPECT_RATIO_APPS_LIST);
        private final Uri mScreenRatioEnabledUri = Settings.System.getUriFor(Settings.System.AICP_ASPECT_RATIO_APPS_ENABLED);
        ...
        public ScreenRatioSettingsObserver() {
            ...
            mAspectRatioEnabled = Settings.System.getIntForUser(mContext.getContentResolver(),
                    Settings.System.AICP_ASPECT_RATIO_APPS_ENABLED, 0, UserHandle.USER_CURRENT) == 1;
        }
        ...
        public void updateAppList() {
            String apps = Settings.System.getStringForUser(mContext.getContentResolver(),
                    Settings.System.AICP_ASPECT_RATIO_APPS_LIST, UserHandle.USER_CURRENT);
